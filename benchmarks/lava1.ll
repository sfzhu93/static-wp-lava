...
entry:
  ...
  %arrayidx = getelementptr inbounds [1000000 x i32], [1000000 x i32]* @lava_val, i64 0, i64 %idxprom
...
if.then:                                          ; preds = %entry
  %call = tail call i32 (i32, i8*, ...) @dprintf(i32 1, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.1, i64 0, i64 0), i32 %bug_num) #3
  br label %if.end
...
entry:
  ...
  %call7 = tail call i8* @_wp_end(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  ret i32 %add6
}
