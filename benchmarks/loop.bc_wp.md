...
| LLVM Instruction | Precondition |
|-----|-----|
|   %call = tail call i32 @f(i32 %i.021, i32 %sub) | ((if.then and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.020) < 1234567)))) or (if.else and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.020) < 1234567))))) |
|   %sub = add nsw i32 %i.021, -1 | ((if.then and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.020) < 1234567)))) or (if.else and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.020) < 1234567))))) |
# In block for.body, function hello
| LLVM Instruction | Precondition |
|-----|-----|
|   br i1 %cmp1, label %if.then, label %if.else | ((cmp1 and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.020) < 1234567)))) or ((not cmp1) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.020) < 1234567))))) |
|   %cmp1 = icmp sgt i32 %i.021, %div | (((i.021 > div) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.020) < 1234567)))) or ((not (i.021 > div)) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.020) < 1234567))))) |
|   %c.addr.020 = phi i32 [ %c, %for.body.lr.ph ], [ %c.addr.1, %for.inc ] | ((for.body.lr.ph and (((i.021 > div) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c) < 1234567)))) or ((not (i.021 > div)) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c) < 1234567)))))) or (for.inc and (((i.021 > div) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.1) < 1234567)))) or ((not (i.021 > div)) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.1) < 1234567))))))) |
...
| LLVM Instruction | Precondition |
|-----|-----|
|   br i1 %cmp.19, label %for.body.lr.ph, label %for.cond.cleanup | ((cmp.19 and ((cmp.19 and (((a > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c) < 1234567)))) or ((not (a > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c) < 1234567)))))) or (for.inc and (((a > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.1) < 1234567)))) or ((not (a > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.1) < 1234567)))))))) or (for.inc and ((cmp.19 and (((inc > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c) < 1234567)))) or ((not (inc > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c) < 1234567)))))) or (for.inc and (((inc > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.1) < 1234567)))) or ((not (inc > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.1) < 1234567))))))))) |
|   %cmp.19 = icmp slt i32 %a, %b | (((a < b) and (((a < b) and (((a > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c) < 1234567)))) or ((not (a > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c) < 1234567)))))) or (for.inc and (((a > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.1) < 1234567)))) or ((not (a > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.1) < 1234567)))))))) or (for.inc and (((a < b) and (((inc > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c) < 1234567)))) or ((not (inc > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c) < 1234567)))))) or (for.inc and (((inc > ((b + a) / 2)) and ((entry and (c < 1234567)) or (for.inc and (((+ * a) + c.addr.1) < 1234567)))) or ((not (inc > ((b + a) / 2))) and ((entry and (c < 1234567)) or (for.inc and ((call4 + c.addr.1) < 1234567))))))))) |
